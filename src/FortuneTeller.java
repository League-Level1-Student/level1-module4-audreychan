...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	FortuneTeller() throws Exception {
		...
		fortuneTellerImage = ImageIO.read(getClass().getResource("Trelawney.jpg"));
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Welcome to our secret, corner of the world, fortune tellers booth!");
